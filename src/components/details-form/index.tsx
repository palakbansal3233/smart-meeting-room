...
const DetailsForm = () => {
    ...
    const { date: dateFromRoute, startTime: startTimeFromRoute, endTime: endTimeFromRoute, building: buildingFromRoute } = location.state as IRoomState || {};
    ...
    function submitForm(event: React.SyntheticEvent) {
        ...
        navigate('select-room', { state: { building, startTime, endTime, date: dateInFormat } as IRoomState });
    }
